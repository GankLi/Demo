...
public class AppUpdateProgress extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (textIsDisplayable && style == STROKE) {
            ...
            String str2 = "共"+ max +"个";
            float width1 = paint.measureText(str1);
            float width2 = paint.measureText(str2);
            canvas.drawText(str1, centre - width1 / 2, centre , paint);
            canvas.drawText(str2, centre - width2 / 2, centre + textSize + 3, paint);
        }
