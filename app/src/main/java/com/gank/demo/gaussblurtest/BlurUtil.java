...
public class BlurUtil {
    ...
    public static Bitmap gaussBlurUseJava(Bitmap sentBitmap, int radius, boolean canReuseInBitmap) {
    ...
    public static Bitmap gaussBlurUseRenderScript(Bitmap bitmap, int radius, Context context) {
